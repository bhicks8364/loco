...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { contact_name: @band.contact_name, name: @band.name, phone_number: @band.phone_number }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { contact_name: @band.contact_name, name: @band.name, phone_number: @band.phone_number }
    assert_redirected_to band_path(assigns(:band))
  end
